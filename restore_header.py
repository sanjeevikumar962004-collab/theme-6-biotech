                        ...
                        <div data-w-id="afe2f1da-482a-96b7-6275-c2c9d5539303" class="w-layout-hflex rt-phone">
                            ...
                            <div class="w-layout-vflex rt-phone-number-wrapper">
                                <a href="tel:8884567890" class="rt-link-decor-off w-inline-block">
                                    <div
                                        class="rt-button-text-style rt-text-color-white rt-font-weight-semi-bold rt-number-hover w-variant-dc66bbc0-e9e8-4e3d-2de0-76f535d749e7">
                                        (888) 123 4560</div>
                                </a>
                            </div>
                        </div>
...
files_to_update = ['index.html', 'about.html', 'blog.html', 'contact2.html']
...
for f_name in files_to_update:
    try:
        ...
        # We need to replace the <header class="stackly-header"> ... </header> block
        content = re.sub(r'<header class="stackly-header">.*?</header>', old_header, content, flags=re.DOTALL)
        
        with open(f_name, 'w', encoding='utf-8') as f:
            f.write(content)
        print(f"Updated {f_name}")
    except Exception as e:
        print(f"Failed on {f_name}: {e}")
